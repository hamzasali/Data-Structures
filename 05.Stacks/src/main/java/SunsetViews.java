...
public class SunsetViews {
    ...
    public static ArrayList<Integer> sunsetViews(int[] buildings, String direction) {
        ...
        //this is for east side
        int i = 0;
        int step = 1;

        //this is for west side
 ...
 * indices of the buildings that can see the sunset. A building can see the sunset if it's strictly
 * taller than all of the buildings that come after it in the direction that it faces. The input array
 * named buildings contains positive, non-zero integers representing the heights of the buildings.
